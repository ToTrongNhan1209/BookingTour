                ...
                <div className="direc-detail">
                    <section className="blog-detail-breadcrumb">
                        ...
                        <div className="breadcrumb-separator">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M9 6L15 12L9 18" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                        </div>
                        <span>Blogs</span>
                        <div className="breadcrumb-separator">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M9 6L15 12L9 18" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                        </div>
                        <span>Top 5 loại trà Đà Lạt ngon mà bạn nhất định phải thử</span>
                    </section>
                </div>
            </div>
        </>
